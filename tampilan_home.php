                                    ...
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demoevent" href="#">Professors <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="demoevent" class="collapse dropdown-header-top">
                                                <li><a href="<?php echo site_url('C_dosen')?>">All Professors</a>
                                                </li>
                                                <li><a href="<?php echo site_url('C_dosen')?>">Add Professor</a>
                                                </li>
                                                <li><a href="<?php echo site_url('C_dosen')?>">Edit Professor</a>
                                                </li>
                                                <li><a href="<?php echo site_url('C_dosen')?>">Professor Profile</a>
                                                </li>
                                            </ul>
                                        </li>
